...
#
# Example run:
# wget -qO- "https://raw.githubusercontent.com/Saiedf/ServiceScanUpdatesIet5/main/installer_servicescanupdatesiet5_auto.sh" | /bin/sh
#
# Alternative:
# wget -O /tmp/installer_servicescanupdatesiet5_auto.sh "https://raw.githubusercontent.com/Saiedf/ServiceScanUpdatesIet5/main/installer_servicescanupdatesiet5_auto.sh" && chmod 755 /tmp/installer_servicescanupdatesiet5_auto.sh && /bin/sh /tmp/installer_servicescanupdatesiet5_auto.sh
# ==========================================================

PACKAGE_NAME='enigma2-plugin-extensions-servicescanupdatesiet5'
LEGACY_PACKAGE_NAME='enigma2-plugin-extensions-ServiceScanUpdatesIet5'
PLUGIN_TITLE='ServiceScanUpdatesIet5'
PLUGIN_FOLDER='ServiceScanUpdatesIet5'

REPO_USER='Saiedf'
REPO_NAME='ServiceScanUpdatesIet5'
REPO_BRANCH='main'
