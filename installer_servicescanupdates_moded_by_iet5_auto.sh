...
# Plugin   : ServiceScanUpdates Moded By Iet5
...
#
# Example run:
# wget -qO- "https://raw.githubusercontent.com/Saiedf/ServiceScanUpdates Moded By Iet5/main/installer_servicescanupdates_moded_by_iet5_auto.sh" | /bin/sh
#
# Alternative:
# wget -O /tmp/installer_servicescanupdates_moded_by_iet5_auto.sh "https://raw.githubusercontent.com/Saiedf/ServiceScanUpdates Moded By Iet5/main/installer_servicescanupdates_moded_by_iet5_auto.sh" && chmod 755 /tmp/installer_servicescanupdates_moded_by_iet5_auto.sh && /bin/sh /tmp/installer_servicescanupdates_moded_by_iet5_auto.sh
# ==========================================================

PACKAGE_NAME='enigma2-plugin-extensions-servicescanupdates_moded_by_iet5'
LEGACY_PACKAGE_NAME='enigma2-plugin-extensions-ServiceScanUpdates Moded By Iet5'
PLUGIN_TITLE='ServiceScanUpdates Moded By Iet5'
PLUGIN_FOLDER='ServiceScanUpdatesModedByIet5'

REPO_USER='Saiedf'
REPO_NAME='ServiceScanUpdatesModedByIet5'
REPO_BRANCH='main'
